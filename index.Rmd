...
You roll over to your coin flipping table, get out your laptop and flip your quarter six times. 
...
Okay, so we got __two__ heads on our __six__ flips. Obviously the data given to us is from an unfair coin. You're a good [frequentist](https://en.wikipedia.org/wiki/Frequentist_inference) however, so you decide that, to be safe, you should repeat the experiment again to see what you get. 

_Oh no, you dropped your coin, better use R instead._

```{r}
#Function to flip our coin six times
...
Well look at that, investigating this plot it doesn't actually seem that out of the ordinary to get four tails in six flips, even though intuitively that sounds like tails happening twice as often as heads. 
...
<p align = "middle", style = "font-size: 4; font-style:italic">
  ...
  <img style="width:45%" src="http://starecat.com/content/wp-content/uploads/dog-calculating-how-to-carry-a-stick-on-a-bridge.gif" align="middle"> 
  </br> 
